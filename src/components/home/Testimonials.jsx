      ...
      <Container className="flex flex-col items-center gap-12">
        ...
        <div className="relative w-full max-w-3xl">
          <AnimatePresence mode="wait">
            ...
            >
              <GlassCard variant="strong" className="flex flex-col items-center gap-6 px-6 py-10 text-center sm:px-14">
                <span className="font-display text-6xl leading-none text-royal-300">&ldquo;</span>
                <Stars />
                <p className="text-base leading-relaxed text-ink-800/90 sm:text-lg">
                  {t.quote}
                </p>
                <div className="flex items-center gap-3">
                  <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-royal-600 to-gold-500 font-display text-lg font-bold text-white">
                    {t.initial}
                  </span>
                  <div className="text-left">
                    ...
                    <p className="text-xs font-medium text-royal-600">TIAMA Certified</p>
                  </div>
                </div>
              </GlassCard>
            </motion.div>
          ...
          <button
            ...
            className="glass-panel absolute left-0 top-1/2 hidden h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full text-ink-800 transition-transform duration-300 hover:scale-110 sm:flex"
          >
          ...
          <button
            ...
            className="glass-panel absolute right-0 top-1/2 hidden h-11 w-11 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full text-ink-800 transition-transform duration-300 hover:scale-110 sm:flex"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          {testimonials.map((_, i) => (
            <button
              ...
              className={cn(
                ...
                i === index ? "w-8 bg-royal-500" : "w-1.5 bg-ink-900/20 hover:bg-ink-900/40"
              )}
            />
          ))}
        </div>
